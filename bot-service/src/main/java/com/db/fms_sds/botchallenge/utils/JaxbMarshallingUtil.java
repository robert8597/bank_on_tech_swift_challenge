...
public class JaxbMarshallingUtil {
    ...
    /**
     * Unmarshalls an XML stream into a Java object of the specified type.
     * This method does not perform schema validation.
     *
     * @param inputStream The XML content as an InputStream.
     * @param targetClass The target class to convert the XML into.
     * @param <T>         The generic type of the target object.
     * @return An object of type T containing the data from the XML.
     * @throws JAXBException if an error occurs during unmarshalling.
     */
    public <T> T unmarshall(InputStream inputStream, Class<T> targetClass) throws JAXBException {
        log.debug("Unmarshalling XML stream for class {}", targetClass.getSimpleName());
